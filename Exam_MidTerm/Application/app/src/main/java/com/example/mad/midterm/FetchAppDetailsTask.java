...
public class FetchAppDetailsTask extends AsyncTask<String, Void, ArrayList<App>> {

    IData activity;

    public FetchAppDetailsTask(IData activity) {
    ...
    protected ArrayList<App> doInBackground(String... params) {
        ...
        try {
            ...
            if (statusCode == HttpURLConnection.HTTP_OK) {
                ...
                return AppJSONParser.pasrseApp(sb.toString());
            }
