...
public class DeleteExpense extends Activity implements DatePickerDialog.OnDateSetListener {
    Calendar calendar;
    EditText edtTxtDate;
    Expense expense;
    ...
    public void showCalendar(View view) {
        DatePickerDialog dialog = new DatePickerDialog(DeleteExpense.this, this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),
